          ...
          <div class="container-fluid">
            ...
            <div class="row mb-1">
              ...
              <div class="page-title-box">
                  <h4 class="mb-sm-0 font-size-18">Industries Sub Type List</h4>
              </div>                      
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                  <li class="breadcrumb-item active">Industries Sub Type List</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="container-fluid">
              <div class="row">
                  <div class="col-md-7">
                      <div class="d-flex">
                          <div>
                            <a href="industriesSubTypeAdd.php" class="btn btn-primary myNewLinkBtn">Add Industries Sub Type</a>
                          </div>
                      </div>      
                  </div>
                          ...
                          <table class="table mainTable mb-0" id="mytable">
                              <thead>
                                  <tr>
                                    ...
                                    <th class="pl-2">Industries Sub Type Name</th>
                                    ...
                                    foreach ($result as $value) {
                                      ...
                                      <tr>
                                        ...
                                        <td class="fontFourteen">
                                          <p class="mb-0"><?php if(!empty($industries_sub_type_name)){ echo $industries_sub_type_name; } ?></p>
                                        ...
                                        <td>
                                            ...
                                            <a href="industriesSubTypeEdit.php?id=<?php if(!empty($id)){ echo $id; } ?>" class="btn far fa-edit actionEdit" title="Edit Record"></a>


                                            <?php 
                                              if ($is_active==1) {
                                                ?><a onclick="return confirm('Are you sure you want to deactive this?');" href="backend/industriesSubTypeActive.php?id=<?php echo $id; ?>&&is_active=<?php echo $is_active; ?>" class="btn actionStar text-warning actionWarning" ><i style="color: #f1bf0a;" class="fas fa-star"></i></a>
                                                <?php
                                              }else{
                                                ?><a onclick="return confirm('Are you sure you want to active this?');" href="backend/industriesSubTypeActive.php?id=<?php echo $id; ?>&&is_active=<?php echo $is_active; ?>" class="btn actionStar text-warning actionWarning" ><i style="color: #ccc;" class="fas fa-star"></i></a>
                                                <?php
                                              }
                                            ?>
                                            <!-- <a href="backend/industriesSubTypeDelete.php?id=<?php if(!empty($id)){ echo $id; } ?>" onclick="return confirm('Are you sure you want to delete this record?');" class="btn far fa-trash-alt actionDelete" title="Delete Record"></a> -->
                                        </td>
                                      </tr>
                                      <?php
                                      $sr_no = $sr_no+1;
