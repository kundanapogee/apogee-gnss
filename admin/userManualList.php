          ...
          <div class="container-fluid">
            ...
            <div class="row mb-1">
              ...
              <div class="page-title-box">
                  <h4 class="mb-sm-0 font-size-18">User Manual List</h4>
              </div>                      
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                  <li class="breadcrumb-item active">User Manual List</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="container-fluid">
              <div class="row">
                  <div class="col-md-7">
                      <div class="d-flex">
                          <div>
                            <a href="userManualAdd.php" class="btn btn-primary myNewLinkBtn">Add User Manual</a>
                          </div>
                      </div>      
                  </div>
                          ...
                          <table class="table mainTable mb-0" id="mytable">
                              <thead>
                                  <tr>
                                    ...
                                    <th class="pl-2">User Manual Name</th>
                                    ...
                                    foreach ($result as $value) {
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="userManualEdit.php?id=<?php if(!empty($id)){ echo $id; } ?>" class="btn far fa-edit actionEdit" title="Edit Record"></a>

                                            <a href="backend/userManualDelete.php?id=<?php if(!empty($id)){ echo $id; } ?>" onclick="return confirm('Are you sure you want to delete this record?');" class="btn far fa-trash-alt actionDelete" title="Delete Record"></a>
                                        </td>
                                      </tr>
                                      <?php
                                      $sr_no = $sr_no+1;
