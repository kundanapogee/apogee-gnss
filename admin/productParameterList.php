<?php
  ...
  $query = $conn->prepare("SELECT * From product_parameter order by id desc");
  $query->execute();
          ...
          <div class="container-fluid">
            ...
            <div class="row mb-1">
              ...
              <div class="page-title-box">
                  <h4 class="mb-sm-0 font-size-18">Product Parameter List</h4>
              </div>                      
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                  <li class="breadcrumb-item active">Product Parameter List</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="container-fluid">
              <div class="row">
                  <div class="col-md-7">
                      <div class="d-flex">
                          <div>
                            <a href="productParameterAdd.php" class="btn btn-primary myNewLinkBtn">Add Product Parameter</a>
                          </div>
                      </div>      
                  </div>
                          ...
                          <table class="table mainTable mb-0" id="tableSearch">
                              <thead>
                                  <tr>
                                    ...
                                    <th class="pl-2">Key Point</th>
                                    <th class="pl-2">Key Value</th>
                                  ...
                                  if ($row>0) {
                                    ...
                                    foreach ($result as $value) {
                                      ...
                                      if (!empty($product_sub_type_id)) {
                                        $query = $conn->prepare("SELECT * From product_sub_type where id = :product_sub_type_id order by id desc");
                                      ...
                                      <tr>
                                        ...
                                        <td class="fontFourteen"><?php if(!empty($key_point)){ echo $key_point; } ?></td>
                                        <td class="fontFourteen"><?php if(!empty($key_value)){ echo $key_value; } ?></td>
                                        ...
                                        <td>
                                            <!-- <a href="productParameterDetail.php?id=<?php if(!empty($id)){ echo $id; } ?>" class="btn far fa-eye actionView" title="View Detail"></a> -->
                                            <a href="productParameterEdit.php?id=<?php if(!empty($id)){ echo $id; } ?>" class="btn far fa-edit actionEdit" title="Edit Record"></a>
                                            <a href="backend/productParameterDelete.php?id=<?php if(!empty($id)){ echo $id; } ?>" onclick="return confirm('Are you sure you want to delete this record?');" class="btn far fa-trash-alt actionDelete" title="Delete Record"></a>
                                        </td>
                                      </tr>
                                      <?php
                                      $sr_no = $sr_no+1;
